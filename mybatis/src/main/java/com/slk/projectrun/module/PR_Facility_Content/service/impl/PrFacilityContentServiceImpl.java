package com.slk.projectrun.module.PR_Facility_Content.service.impl;

import com.slk.projectrun.module.PR_Facility_Content.mapper.PrFacilityContentMapper;
...
public class PrFacilityContentServiceImpl implements PrFacilityContentService {
    ...
    public Map<String,Object> deleteByFid(Integer fid) {
        Map<String, Object> map = new HashMap<>();
        Boolean flag = facilityContentMapper.deleteByPrimaryKey(fid)==1;
        map.put("flag",flag);
    ...
    public Map<String,Object> selectAll() {
        ...
        List<PrFacilityContent> list = facilityContentMapper.selectAll();
        if(list.size()>0){
            map.put("flag",true);
